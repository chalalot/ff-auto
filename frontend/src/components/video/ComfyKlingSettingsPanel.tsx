...
import type { ComfyKlingSettings } from '@/types/video'

interface Props {
  value: ComfyKlingSettings
  onChange: (s: ComfyKlingSettings) => void
}

export const DEFAULT_COMFY_KLING_SETTINGS: ComfyKlingSettings = {
...
export const ComfyKlingSettingsPanel: React.FC<Props> = ({ value, onChange }) => {
  const set = <K extends keyof ComfyKlingSettings>(key: K, val: ComfyKlingSettings[K]) =>
        ...
        <div className="space-y-1.5">
          ...
          <Select value={value.model_name} onValueChange={v => set('model_name', v)}>
            ...
            <SelectContent>
              ...
              <SelectItem value="kling-v2-5">kling-v2-5</SelectItem>
              <SelectItem value="kling-v2-0-turbo">kling-v2-0-turbo</SelectItem>
              <SelectItem value="kling-v2-0">kling-v2-0</SelectItem>
              <SelectItem value="kling-v1-6-turbo">kling-v1-6-turbo</SelectItem>
